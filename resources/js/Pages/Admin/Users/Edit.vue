...
<template>
    <LayoutAdmin>
        ...
        <FormCard title="EDITAR USUARIO" :submit="submit" back="admin.user">
            <ErrorsValidate></ErrorsValidate>

            <div
                class="flex flex-col md:flex-row md:space-x-5 md:space-y-0 space-y-3"
            >
            ...
            <div class="flex  flex-col md:flex-row  md:mr-3">
                <div class="line md:w-1/2">
                    <select
                        class="line__input"
                        id="enabled"
                    ...
                    <span for="enabled" class="line__placeholder"> Estado  </span>
                </div>
            </div>
        </FormCard>
    </LayoutAdmin>
