...
const typesFile = ["video/mp4", "video/x-flv", "video/x-msvideo", "video/3gpp"];
const uploadFiles = (e) => {
...
const submit = () => {
    form.post(route("admin.marketing_update_video",props.marketing?.id), {});
};
</script>
